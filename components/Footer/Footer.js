    ...
    <div className="bg-white shadow-lg mt-10 border-t-2 ">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <div className="flex space-x-9 mt-3 justify-center">
                <div>
                <Link href="https://www.facebook.com/scholarshipcenter">
                    <svg
                ...
                <div>
                <Link href="http://t.me/scholarshipcenter">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32"
                    height="32"
                ...
                <div>
                <Link href="https://www.tiktok.com/@scholarshipcenter?_t=8hoC3NyqV2Q&_r=1">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="28.25"
                    height="32"
            ...
            <span className="border-t-2 mt-6 p-3 block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link href="/" className="hover:underline">CSC™</Link>. All Rights Reserved.</span>
        </div>
    </div>
  )
}
