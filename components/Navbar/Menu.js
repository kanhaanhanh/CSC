    ...
    <>
        <div className='flex justify-center items-center text-sm'>
            <Link href={`/`} className={ page === '/' ? 'font-medium  mx-3 my-1 bg-green-600 rounded-full text-white text-xs px-2 py-1 transition' : 'font-medium mx-3 my-1 hover:bg-green-600 rounded-full hover:text-white text-xs px-2 py-1 transition' }>Home</Link>
            {
              ...
              <Link href={`/dashboard/setting`} className={ page === '/dashboard/setting' ? 'font-medium mx-3 my-1 bg-green-600 rounded-full text-white text-xs px-2 py-1 transition' : 'font-medium mx-3 my-1 hover:bg-green-600 rounded-full hover:text-white text-xs px-2 py-1 transition' }>Setting</Link>
